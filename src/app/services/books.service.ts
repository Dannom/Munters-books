...
export class BooksService {
  // reaching google books api with a random search word 'find' and get 40 items was the max number of items i could get
  readonly url =
    'https://www.googleapis.com/books/v1/volumes?q=find&startIndex=1&maxResults=40';
